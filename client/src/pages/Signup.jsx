    ...
    return (
        <Container className='flex' height='100vh'>
            ...
            <div className='w-[70vw] h-[100%] flex flex-col justify-center items-center gap-10 relative'>
                <div className={`bg-red-400 w-full h-auto ${msg ? "p-2" : ""} text-center text-black absolute top-0 left-0 overflow-hidden text-xl`}>{msg}
                </div>
                ...
                <form onSubmit={handleSubmit(submit)} className='w-auto h-auto flex flex-col items-center justify-center'>
                    ...
                    <Input
                        ...
                        label={<i className="fa-solid fa-at"></i>}
                    />
                    ...
                    <NavLink to='/login' className='self-start ml-6 text-blue-500 underline hover:text-blue-800'>Already registered? Sign In</NavLink>
                    <Button
                        type='submit'
                        className='mt-4'
                    >Sign Up</Button>
